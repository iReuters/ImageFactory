        ...
        if (mEZDeviceInfo != null) {
            mOnClickListener = new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    } else if (id == R.id.defence_plan_button) {
                        setDefencePlanNew(false);
                    } else if (id == R.id.defence_plan_status_retry) {
                        setDefencePlanNew(false);
                    } else if (id == R.id.defence_plan_set_layout) {
                        if (mDefencePlanArrowView.getVisibility() == View.VISIBLE) {
                        }
                        setDefencePlanNew(false);
                    } else if (id == R.id.defence_plan_retry) {
                        setDefencePlanNew(false);
                    } else if (id == R.id.storage_layout) {
