...
//                handleSearchEZDeviceFileSuccess();
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.remoteplayback_loading_play_btn) {
            startRemotePlayBack(getTimeBarSeekTime());
        } else if (id == R.id.remoteplayback_play_btn || id == R.id.remoteplayback_full_play_btn) {
        ...
        } else if (id == R.id.remoteplayback_replay_btn) {
            if (mStatus != STATUS_STOP) {
                stopRemotePlayBack();
            }
            startRemotePlayBack(null);
        } else if (id == R.id.remoteplayback_sound_btn || id == R.id.remoteplayback_full_sound_btn) {
            onSoundBtnClick();
        } else if (id == R.id.remoteplayback_previously_btn || id == R.id.remoteplayback_full_previously_btn || id == R.id.remoteplayback_small_previously_btn) {
            onCapturePicBtnClick();
        } else if (id == R.id.remoteplayback_capture_rl) {
            onCaptureRlClick();
        } else if (id == R.id.remoteplayback_video_btn || id == R.id.remoteplayback_full_video_btn || id == R.id.remoteplayback_small_video_btn || id == R.id.remoteplayback_video_start_btn || id == R.id.remoteplayback_full_video_start_btn || id == R.id.remoteplayback_small_video_start_btn) {
            onRecordBtnClick();
