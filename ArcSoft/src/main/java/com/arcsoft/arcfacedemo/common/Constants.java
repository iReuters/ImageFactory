...
public class Constants {
    ...
    public static final String APP_ID = "DkPCKxtdKL1T1t6VUjw7qy9XxZ16mo3KiRZJ7KYhLDdP";
    public static final String SDK_KEY = "97v3pq3sLcvdjXfKgRqE7sKW3wqLhughejskpj2S4ak6";
